...
pub fn Time(comptime epoch_length: u32, comptime slot_period: u32, comptime ticket_submission_end_epoch_slot: u32) type {
    return struct {
        ...
        pub fn init(prior_slot: u32, current_slot: u32) Self {
            ...
            const prior_slot_in_epoch = prior_slot % epoch_length;
            ...
            return .{
                ...
                .prior_slot_in_epoch = prior_slot_in_epoch,
        ...
        pub fn slotsUntilTicketSubmissionEnds(self: Self) ?u32 {
            if (!self.is_in_ticket_submission_period) {
                return null;
            }
        ...
        pub fn format(
            ...
            try writer.print(
                ...
                \\  Seconds: {d}
                \\  Is New Epoch: {any}
                \\  Is Consecutive Epoch: {any}
                \\  In Ticket Submission Period: {any}
